...
//function Transporter(pos){
	//this.basePos = this.pos = pos.plus(new Vector1(0.2,0.1));
	//this.size = new Vector1 (0.8,0.8);
	//this.wobble1 = Math.random() *Math.PI *3;
//}
//Transporter.prototype.type = 'transporter';

//function Vector1(x, y) {
 // this.x = x; this.y = y;
//}
...
//var wobbleSpeed1 = 4;
//var wobbleDist1 = 0.15;
//Transporter.prototype.act = function(step){
	//this.wobble1 += step * wobbleSpeed1;
	//var wobblePos1 = Math.sin(this.wobble1) * wobbleDist1;
	//this.pos = this.basePos.plus(new Vector1(0, wobblePos1));
//};
var maxStep = 0.05;
